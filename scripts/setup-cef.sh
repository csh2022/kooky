...
CEF_PLATFORM_DEFAULT="macosarm64"
CEF_SHA1_DEFAULT="96dfcb1c89413cd8c740d8abc424e1134c4ae20b"
...
CEF_PLATFORM="${KOOKY_CEF_PLATFORM:-$CEF_PLATFORM_DEFAULT}"
...
ARCHIVE_PATH="${TMP_DIR}/${CEF_ARCHIVE}"
