...
final class HookServerTests: XCTestCase {
    ...
    func testParseBrowserInteractionPayloads() throws {
        let cases: [(String, HookBrowserCommand)] = [
            ...
            (#"{"surface":"\#(Self.surfaceUUID.uuidString)","kind":"browser","command":"credentials"}"#, .credentials),
            (#"{"surface":"\#(Self.surfaceUUID.uuidString)","kind":"browser","command":"save-credential"}"#, .saveCredential),
            (#"{"surface":"\#(Self.surfaceUUID.uuidString)","kind":"browser","command":"fill-credential","account":"csh"}"#, .fillCredential(account: "csh")),
