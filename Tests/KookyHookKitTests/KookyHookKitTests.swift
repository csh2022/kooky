...
final class KookyHookKitTests: XCTestCase {
    ...
    func testBrowserHelpDocumentsCurrentCommands() {
        ...
        XCTAssertTrue(help.contains("browser credentials"))
        XCTAssertTrue(help.contains("browser save-credential"))
        XCTAssertTrue(help.contains("browser fill-credential [account]"))
    ...
    func testBuildBrowserInteractionPayloads() {
        ...
        XCTAssertEqual(KookyHookKit.buildBrowserCredentialPayload(surface: "abc", command: "credentials")["command"], "credentials")
        XCTAssertEqual(KookyHookKit.buildBrowserCredentialPayload(surface: "abc", command: "fill-credential", account: "csh")["account"], "csh")
